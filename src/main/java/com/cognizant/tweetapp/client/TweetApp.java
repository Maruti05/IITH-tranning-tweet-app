				...
				if (status) {
					...
					do {
						...
						case 1:
						{
						 ...
						 if(isPosted) System.out.println("Your Tweet has succsfully posted");
						 else System.err.println("Your Tweet not posted .. Somthing went wrong !");
							break;
						}
						case 2:
						{
						...
						case 4:
						{
							List<User>	users=twtService.viewAllTweets();
						...
						case 5:
						{
							...
							if(isReset) System.out.println("Password Changed succfully ..");
							else System.err.println("Somthing went wrong re-try again !");
							break;
						}
						case 6:
						{
							...
							if(isLoggedout) System.out.println("Logout succsfully..");
							else System.err.println("Somthing went wrong ..");
							break;
						}
						default:
